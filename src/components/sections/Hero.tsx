                ...
                <div className="flex items-center gap-1 bg-slate-200/60 p-1 rounded-lg text-xs font-medium text-textSecondary">
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-md transition-all ${
                      activeTab === 'code' ? 'bg-white text-primary shadow-xs font-semibold' : 'hover:text-textPrimary'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-md transition-all ${
                      activeTab === 'stack' ? 'bg-white text-primary shadow-xs font-semibold' : 'hover:text-textPrimary'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-md transition-all ${
                      activeTab === 'status' ? 'bg-white text-primary shadow-xs font-semibold' : 'hover:text-textPrimary'
                    }`}
                  >
